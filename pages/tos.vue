    ...
    <div class="">
        ...
        <section id="legal" class="container is-widescreen py-6 px-4">
            <div class="content is-medium mt-6">
                ...
                <p class="subtitle">Last updated: Jan 25, 2022</p>
            </div>
            <div id="definition" class="">
            <p class="subtext pb-2">
          ...
          <div id="service-disruption-terminate" class="py-6">
            ...
            <p class="subtext pb1">
              You can stop using the Services at any time. If you’d like to know how we handle the information you provide, please refer to the Privacy Policy <NuxtLink to="https://saturdays.io/privacy" rel="noreferrer" target="_blank">https://saturdays.io/privacy</NuxtLink>.
            </p>
            <p class="subtext pb1">
